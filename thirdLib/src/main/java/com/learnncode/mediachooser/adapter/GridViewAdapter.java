...
public class GridViewAdapter extends ArrayAdapter<MediaModel> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(mIsFromVideo){
			new VideoLoadAsync(videoFragment, holder.imageView, false, mWidth/3).executeOnExecutor(MediaAsync.THREAD_POOL_EXECUTOR, mGalleryModelList.get(position).url.toString());
