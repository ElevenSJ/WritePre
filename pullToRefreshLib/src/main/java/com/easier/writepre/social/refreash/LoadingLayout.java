 ...
 *******************************************************************************/
package com.easier.writepre.social.refreash;


import com.easier.writepre.social.refreash.PullToRefreshBase.Mode;
import com.easier.writepre.social.refreash.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		case PULL_FROM_END:
			...
			// Load in labels
			mPullLabel = context.getString(R.string.loading);
			mRefreshingLabel = context.getString(R.string.loading);
			mReleaseLabel = context.getString(R.string.load_more);
			break;
