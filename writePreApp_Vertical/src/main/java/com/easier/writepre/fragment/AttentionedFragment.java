...
import com.easier.writepre.param.UserCareParams;
 ...
 * 
 */
public class AttentionedFragment extends BaseFragment implements
	...
	protected void init() {
		...
		adapter = new AttentionAdapter(_id, getActivity(), 0, mHandler);
	...
	private void loadRefresh() {
		...
		start = 0;
		count = 30;
		UserCareParams params = new UserCareParams(_id, "" + start, "" + count);
