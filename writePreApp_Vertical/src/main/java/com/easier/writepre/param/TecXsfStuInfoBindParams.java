 ...
 * 考生信息绑定
 */
public class TecXsfStuInfoBindParams extends BaseBodyParams {
	...
	public TecXsfStuInfoBindParams(String real_name, String id_num, String city, String addr, String school_name, String school_contact, String photo_url) {
	...
	public TecXsfStuInfoBindParams(String real_name, String id_num, String city, String addr, String school_name, String school_contact, String photo_url, String stu_type) {
		this.real_name = real_name;
		this.id_num = id_num;
		this.city = city;
		this.addr = addr;
