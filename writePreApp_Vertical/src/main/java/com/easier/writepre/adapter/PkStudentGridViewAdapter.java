...
public class PkStudentGridViewAdapter extends BaseAdapter {
	...
	public PkStudentGridViewAdapter(Context context, List<PkContentInfo> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.pk_teacher_student_grid_item, null);
			holder.tv_teacher_student_name = (TextView) convertView.findViewById(R.id.tv_teacher_student_name);
			holder.tv_teacher_student_ticket = (TextView) convertView.findViewById(R.id.tv_teacher_student_ticket);
			holder.iv_teacher_student_bg = (ImageView) convertView.findViewById(R.id.iv_teacher_student_bg);
		...
		final PkContentInfo cInfo = getItem(position);
...
//		BitmapHelp.getBitmapUtils().display(holder.iv_teacher_student_head, StringUtil.getHeadUrl(cInfo.getHead_img()),
...
//				});
		if(cInfo.getWorks().getImgs() != null){
			BitmapHelp.getBitmapUtils().display(holder.iv_teacher_student_bg,
					StringUtil.getImgeUrl(cInfo.getWorks().getImgs()[0]) + Constant.SMALL_IMAGE_SUFFIX,
					new BitmapLoadCallBack<View>() {
						...
						@Override
						public void onLoadFailed(View arg0, String arg1, Drawable arg2) {
							holder.iv_teacher_student_bg.setImageResource(R.drawable.empty_photo);
		...
		holder.tv_teacher_student_name.setText(StringUtil.FormatStrLength(cInfo.getUname(), 4));
