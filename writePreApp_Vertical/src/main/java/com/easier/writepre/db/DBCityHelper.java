...
public class DBCityHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.easier.writepre/databases/";
	/*
	 ...
	 */
	public DBCityHelper(Context context, String name, CursorFactory factory,
			int version) {
	...
	public DBCityHelper(Context context, String name, int version) {
		this(context, name, null, version);
	}

	public DBCityHelper(Context context, String name) {
