...
public class TaskChildViewPager extends ViewPager {
    ...
    public TaskChildViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
//        addOnPageChangeListener(new MyOnPageChangeListener());
    }

    public TaskChildViewPager(Context context) {
        super(context);
    }
