...
public class ViewPageIndicator extends View implements PageIndicator {
	...
	public ViewPageIndicator(Context context, AttributeSet attrs) {
		...
		mPaintPageFill.setColor(res.getColor(R.color.indicator_snow));
		mPaintStroke.setStyle(Style.STROKE);
		mPaintStroke.setColor(res.getColor(R.color.indicator_dark));
		mPaintStroke.setStrokeWidth(2);
		mPaintFill.setStyle(Style.FILL);
		mPaintFill.setColor(res.getColor(R.color.indicator_bg));
		mRadius = 8;
		mSnap = false;
