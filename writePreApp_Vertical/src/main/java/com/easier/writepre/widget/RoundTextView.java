...
public class RoundTextView extends TextView {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			roundWidth = a.getDimensionPixelSize(R.styleable.RoundTextView_roundWidth, roundWidth);
			roundHeight = a.getDimensionPixelSize(R.styleable.RoundTextView_roundHeight, roundHeight);
		} else {
