 ...
 * 考生信息绑定
 */
public class TecXsfStuInfoBindResponse extends BaseResponse {
	
	private TecXsfStuInfoBindBody  repBody;
	
	public TecXsfStuInfoBindBody getRepBody() {
		return repBody;
	}

	public void setRepBody(TecXsfStuInfoBindBody repBody) {
		this.repBody = repBody;
	}

	public class TecXsfStuInfoBindBody implements Serializable {
